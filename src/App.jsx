    ...
    <div className="bg-dark d-flex align-item-center justify-content-center p-3" style={{ minHeight: "100vh", width: '100%' }}>
      <div className='bg-light rounded p-5' style={{ width: '550px' }}>
        ...
        <form className='mt-3'>
            ...
            <div className='mb-3'>
              <TextField name='princple' onChange={e=>validateUserInput(e.target)} value={principle || ""} className='w-100' id="outlined-basic" label="₹Principle Amount" variant="outlined" />
            ...
            </div>
           {
            ...
            <div className='mb-3'>
              <TextField name='interest' onChange={e=>validateUserInput(e.target)} value={interest || ""} className='w-100' id="outlined-basic" label="Rate of Intereset(p.a)%" variant="outlined" />
